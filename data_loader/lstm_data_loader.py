...
class LSTMDataLoader(BaseDataLoader):
    ...
    def get_train_data(self):
        return LSTMDataGenerator(self.batch_size, self.train_split, self.config.exp.num_of_classes)

    def get_test_data(self):
        return LSTMDataGenerator(self.batch_size, self.test_split, self.config.exp.num_of_classes)
